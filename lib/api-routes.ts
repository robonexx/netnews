...
const TECH_URL = `https://content.guardianapis.com/search?page-size=12&order-by=newest&section=technology&show-fields=headline,thumbnail,trailText&q=technology%20AND%20computer&api-key=${APIKEY}`;
const AI_URL = `https://content.guardianapis.com/search?page-size=12&order-by=newest&show-fields=headline,thumbnail,trailText&q=ai%20AND%20robots&api-key=${APIKEY}`;
const HEALTH_URL = `https://content.guardianapis.com/search?page-size=12&section=lifeandstyle&show-fields=headline,thumbnail,trailText&q=health%20AND%20longevity&api-key=${APIKEY}`;
const ENTERTAINMENT_URL = `https://content.guardianapis.com/search?page-size=12&order-by=newest&show-fields=headline,thumbnail,trailText&q=entertainment%20AND%20movies&api-key=${APIKEY}`;
