...
const TECH_URL = `http://content.guardianapis.com/search?page-size=12&order-by=newest&section=technology&show-fields=headline,thumbnail,trailText&q=technology%20AND%20computer&api-key=${APIKEY}`;
