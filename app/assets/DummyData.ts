...
export const dummyNews: NewsArray = [
        ...
        },
        {
          ...
          title: "'Golden Bachelor' recap: Who got Gerry Turner's roses night one? - USA TODAY",
          ...
          urlToImage: 'https://www.usatoday.com/gcdn/authoring/authoring-images/2023/09/28/USAT/70988517007-170002-52831.jpg?crop=2999,1687,x0,y156&width=2999&height=1687&format=pjpg&auto=webp',
          publishedAt: '2023-09-29T01:02:59Z',
          content: 'Yes, there was drama and conniving on the first night of "The Golden Bachelor."\r\n' +
        ...
        },
        {
          ...
          title: 'Automakers grow frustrated over pace of UAW negotiations as new deadline looms - CNBC',
          description: 'Frustrations remain around key economic demands and what some see as a lack of urgency by the union to reach a deal, according to people familiar.',
          url: 'https://www.cnbc.com/2023/09/28/uaw-negotiations-automakers-grow-frustrated-as-new-deadline-looms.html',        
          urlToImage: 'https://image.cnbcfm.com/api/v1/image/107306845-16957484112023-09-26t170415z_298265287_rc2hg3a9lwts_rtrmadp_0_autos-labor-uaw-biden.jpeg?v=1695946354&w=1920&h=1080', 
          publishedAt: '2023-09-29T00:12:00Z',
          content: "Striking members of the United Auto Workers (UAW) picket outside the GM's Willow Run Distribution Center, in Bellville, Wayne County, Michigan, U.S., September 26, 2023.\r\n" +
            'DETROIT Tensions are rising … [+5609 chars]'
        },
        {
          source: { id: 'axios', name: 'Axios' },
          author: 'Axios',
          title: 'Trump halts plans to request Georgia case move to federal court - Axios',
          description: 'blablabl',
          url: 'https://www.axios.com/2023/09/28/trump-georgia-rico-federal-court',
          urlToImage: 'https://images.pexels.com/photos/2146358/pexels-photo-2146358.jpeg?auto=compress&cs=tinysrgb&w=1600',
        ...
        },
        {
          ...
          author: 'The Guardian',
          title: 'Climate Change Agreement: World Leaders Unite for a Sustainable Future',
